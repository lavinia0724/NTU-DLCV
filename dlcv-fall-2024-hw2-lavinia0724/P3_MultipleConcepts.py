...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="a photo of a <new1> next to a <new3>",
    ...
    cat_embedding = torch.load("./models/cat/cat_epoch85.pt")
    model.cond_stage_model.transformer.text_model.embeddings.token_embedding.weight[-1] = cat_embedding
